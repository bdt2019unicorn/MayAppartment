...
<script>
    function Add()
    {
        ...
        $("#ActionForm").attr("action","<?php echo url('Admin/Transactions/Add'); ?>"); 
        $("#btnAction").text("Add"); 
    }
    ...
    function Edit(button)
    {
        ...
        $("#ActionForm").attr("action","<?php echo url('Admin/Transactions/Edit'); ?>"); 
        $("#btnAction").text("Edit"); 
    }
    ...
    function Cancel()
    {
        ...
        var url = "<?php echo url('Admin/Transactions/GetList'); ?>"; 
